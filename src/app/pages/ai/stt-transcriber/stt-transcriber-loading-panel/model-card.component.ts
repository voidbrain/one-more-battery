...
@Component({
  ...
  standalone: true,
  imports: [IonCardContent, NgClass, DecimalPipe, TranslocoModule, IonCard],
})
export class ModelCardComponent {
  ...
  private transcriberConfigStorage = inject(TranscriberConfigStorage);
  ...
  async loadTranscriber(): Promise<void> {
